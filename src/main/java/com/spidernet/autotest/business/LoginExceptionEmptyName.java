...
public class LoginExceptionEmptyName implements IBusiness {
	...
	public boolean excute(WebDriver driver) throws Exception{
	    ...
	    ConfigFile.appendContentToLogFile("***** CASE loginExceptionEmptyName ***** ");
		...
		if (CommonUtils.isElementPresent(driver,By.xpath(ConfigFile.getElementProperties("logonButton"))))
		{
			...
			driver.findElement(By.xpath(ConfigFile.getElementProperties("username"))).sendKeys(ConfigFile.getValueProperties("username2"));
			
			ConfigFile.appendContentToLogFile("Testing with username2:");
			ConfigFile.appendContentToLogFile(ConfigFile.getValueProperties("username2"));
			
			//Find the element of password and put into it.
			driver.findElement(By.xpath(ConfigFile.getElementProperties("password"))).sendKeys(ConfigFile.getValueProperties("password2"));
			
			ConfigFile.appendContentToLogFile("Testing with password2:");
			ConfigFile.appendContentToLogFile(ConfigFile.getValueProperties("password2"));
		    ...
		    else
		    {
		    	...
		    	WebElement logoelement3 = driver.findElement(By.xpath(ConfigFile.getElementProperties("inputUserName")));
